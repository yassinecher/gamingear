          ...
          <div className="flex justify-between">
            ...
            <div className="image-container">
              <div className="block1 rounded-full">
                <img
                  src="/images/logo (3).png"
                  className="h-6 w-6 rounded-full max-w-full"
                  alt=""
                />
              </div>
            </div>
            ...
            <div className="ml-6 flex flex-1 ">
              <div className="flex cursor-pointer select-none items-center  rounded-md border bg-[#f6f47f] py-2 px-4 text-black hover:bg-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h16" />
                </svg>
                <span className="text-sm font-medium md:hidden">Categories</span>
              </div>
              <div className='block2 w-full m-auto  px-3 py-2'>
            <input type="text" placeholder='Search' className='w-full  bg-transparent border-transparent p-2 outline-none ' />
          </div>
                 </div>
