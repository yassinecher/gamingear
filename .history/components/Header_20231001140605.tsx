  ...
  return (<>
    <header className="lg:flex items-center justify-between flex-wrap text-white p-6 blackbg relative z-0">
      ...
      <div className="lg:hidden">
        <button
          onClick={handleClick}
          className="flex items-center px-3 py-2 border rounded text-yellow-100 border-t hover:text-white hover:border-white relative z-50 "
        >
          <svg
            className="fill-current h-5 w-3"
            viewBox="0 0 20 20"
