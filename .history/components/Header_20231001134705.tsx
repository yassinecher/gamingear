...
export default function Header() {
  ...
  return (<>
    <header className="flex items-center justify-between flex-wrap text-white p-6 blackbg relative -z-10">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        <div className="text-xl font-bold relative logo-container flex justify-between items-center">
          ...
          <img
            ...
            className="max-sm:w-32   rounded-full max-w-xs w-52 ml-5"
            alt=""
          />
        </div>
      </div>
      <div className="lg:hidden">
        <button
          onClick={handleClick}
          className="flex items-center px-3 py-2 border rounded text-yellow-100 border-yellow-300 hover:text-white hover:border-white relative z-50 "
        >
          <svg
      ...
      <div
        className={`w-full flex-grow lg:flex lg:items-center lg:w-auto ${isCollapsed ? "hidden" : ""
          }`}
      >
