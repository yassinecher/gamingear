...
export default function Header() {
  ...
  return (<>
    <header className=" text-white p-4 relative -z-10 ">
  ...
  */}
    ...
    <nav className="flex items-center justify-between flex-wrap text-white p-6 blackbg">
      ...
      <div className="block lg:hidden">
        <button onClick={handleClick} className="flex items-center px-3 py-2 border rounded text-yellow-100 border-teal-400 hover:text-white hover:border-white">
      ...
      <div className={`w-full flex-grow lg:flex lg:items-center lg:w-auto ${isCollapsed ? 'hidden' : 'block'}`}>
        <div className="text-sm lg:flex-grow">
          <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-yellow-100 hover:text-white mr-4">
            Docs
          </a>
          <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-yellow-100 hover:text-white mr-4">
            Examples
          </a>
          <a href="#responsive-header" className="block mt-4 lg:inline-block lg:mt-0 text-yellow-100 hover:text-white">
            Blog
          </a>
        </div>
        <div>
