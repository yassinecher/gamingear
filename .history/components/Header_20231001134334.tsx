...
export default function Header() {
  ...
  return (<>
    <nav className="flex items-center justify-between flex-wrap text-white p-6 blackbg relativ -z-10">
      ...
      <div className="block lg:hidden">
        <button
          onClick={handleClick}
          className="flex items-center px-3 py-2 border rounded text-yellow-100 border-yellow-300 hover:text-white hover:border-white z-30 relative"
        >
          <svg
