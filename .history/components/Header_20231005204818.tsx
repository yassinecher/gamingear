        ...
        <div className="border-b border-gray-700 py-3 px-6">
          <div className="flex justify-between">
            ...
            <div className="ml-6 flex flex-1 ">
              ...
              <div className='block2 w-full m-auto  px-3 py-2 ml-6 flex flex-1'>
              <div className="flex cursor-pointer select-none items-center  align-middle  max-lg:hidden rounded-md border bg-[#f6f47f]  px-4 text-black hover:bg-white">
