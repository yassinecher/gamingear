      ...
      <div className="bg-black text-white relative z-0">
        <div className="border-b border-gray-700 py-3 px-6">
          <div className="lg:flex justify-between">
            <div className="flex items-center max-lg:mx-10">
              ...
              <div className="w-full text-xl font-bold relative logo-container flex justify-center items-center">
                <div className="image-container">
                  <div className="block1 rounded-full">
                    <img
                      src="/images/logo (3).png"
                      className="h-7 w-7 rounded-full max-w-full"
                      alt=""
                    />
                  </div>
                </div>
                <div className='max-lg:mx-auto px-3 title ml-2 font-semibold '>Gaming Gear TN</div>
            ...
            <div className="ml-6 flex flex-1 ">
              ...
              <div className='block2 w-full m-auto   ml-6 flex flex-1'>
                <div className="flex cursor-pointer select-none items-center  align-middle  max-lg:hidden cat  bg-transparent  px-4 text-white hover:bg-[#f0f0f0]">
            ...
            <div className="ml-2 flex max-lg:hidden">
