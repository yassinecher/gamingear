  ...
  return (<>
    <nav className="flex items-center justify-between flex-wrap text-white p-6 blackbg relative -z-10">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        <div className="text-xl font-bold relative logo-container flex justify-between items-center">
          ...
          <img
            ...
            className="max-sm:hidden  rounded-full max-w-xs w-52 ml-5"
            alt=""
          />
        </div>
      </div>
      <div className="block lg:hidden">
        <button
          onClick={handleClick}
          className="flex items-center px-3 py-2 border rounded text-yellow-100 border-yellow-400 hover:text-white hover:border-white"
        >
          <svg
