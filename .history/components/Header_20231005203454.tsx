...
export default function Header() {
  ...
  return (
    <>
      <header className="lg:flex items-center justify-between flex-wrap text-white p-6 blackbg relative z-0">
        <div className="flex items-center justify-between text-white ">
          <div className="w-full text-xl font-bold relative logo-container flex justify-center items-center">
            ...
            <div className='max-lg:mx-auto px-3 title text-3xl '>Gaming Gear TN</div>
      ...
      <div>
      {/* Responsive Header */}
      <div className={`lg:hidden bg-black text-white p-6 relative z-0 ${isMenuOpen ? 'menu-open' : 'menu-closed'}`}>
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={toggleMenu}
            className="flex items-center px-3 py-2 border rounded text-yellow-100 border-transparent"
          >
            <svg
              className="fill-current h-5 w-5"
              viewBox="0 0 20 20"
        ...
        <div className="w-full flex-grow mt-4">
          <div className="text-sm">
            <a
              href="#responsive-header"
              className="block mt-4 text-yellow-100 hover:text-white"
            >
              Docs
            </a>
            <a
          ...
          <div className="mt-4">
            <a
              href="#"
              className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-yellow-500 hover:bg-white"
            >
              Download
            </a>
          </div>
      ...
      <div className="hidden lg:flex items-center justify-between flex-wrap text-white p-6 blackbg relative z-0">
        <div className="flex items-center justify-between text-white">
          <div className="w-full text-xl font-bold relative logo-container flex justify-center items-center">
            <div className="image-container">
              <div className="block1 rounded-full">
        ...
        <div className={`w-full flex-grow lg:flex lg:items-center lg:w-auto ${isMenuOpen ? 'menu-open' : 'menu-closed'}`}>
          <div className="text-sm lg:flex-grow">
            <a
              href="#responsive-header"
              className="block mt-4 lg:inline-block lg:mt-0 text-yellow-100 hover:text-white mr-4"
