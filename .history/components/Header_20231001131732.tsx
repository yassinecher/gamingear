...
export default function Header() {
  ...
  <nav className="flex items-center justify-between flex-wrap text-white p-6 blackbg  relative -z-10">
    <div className="flex items-center flex-shrink-0 text-white mr-6">
      <div className="text-xl font-bold relative logo-container  flex justify-between items-center">
        <div className="image-container">
          <div className=" block1 rounded-full ">
            <img
              ...
              className="max-w-xs w-16 rounded-full responsive-img"
              alt=""
            />
          </div>
        </div>
        ...
        <img
          ...
          className="max-w-xs w-72 rounded-full ml-5 responsive-img"
          alt=""
        />
      </div>
    </div>
    <div className="block lg:hidden">
      <button
        onClick={handleClick}
        className="flex items-center px-3 py-2 border rounded text-yellow-100 border-teal-400 hover:text-white hover:border-white"
      >
        <svg
